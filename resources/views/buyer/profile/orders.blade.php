            ...
            <div class="col-lg-9">
                ...
                @if($data['orders']->count() > 0)
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body" style="cursor: pointer;" onclick="window.location='{{ route('buyer.orders.detail', $order->uuid) }}'">
                            ...
                            <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                ...
                                <div onclick="event.stopPropagation();">
                                    ...
                                    <form action="{{ route('buyer.orders.complete', $order->uuid) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('PATCH')
                    ...
                    <div class="modal fade" id="returnModal{{ $order->id }}" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('buyer.orders.return', $order->uuid) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-header">
