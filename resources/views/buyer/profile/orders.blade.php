                    ...
                    @foreach($data['orders'] as $order)
                        <div class="card mb-3">
                            ...
                            <div class="card-body" style="cursor: pointer;"
                                onclick="window.location='{{ route('buyer.orders.detail', $order->uuid) }}'">
                                @foreach($order->items as $item)
                                            <div class="d-flex mb-3 pb-3 {{ !$loop->last ? 'border-bottom' : '' }}">
                                                <img src="{{ $item->product->primaryImage
                                    ? asset('storage/' . $item->product->primaryImage->image_url)
                                    : asset('logo/logo.png') }}" class="rounded me-3"
                                                    style="width: 80px; height: 80px; object-fit: cover;" alt="{{ $item->product->name }}">
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-1">{{ $item->product->name }}</h6>
                                                    <p class="text-muted mb-1">{{ $item->quantity }} x Rp
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                    ...
                                    <div onclick="event.stopPropagation();">
                                        @if($order->status === 'pending' && $order->payment_method === 'midtrans')
                                            <a href="{{ route('buyer.orders.payment', $order->uuid) }}" class="btn btn-primary">
                                        ...
                                        @elseif($order->status === 'shipped')
                                            <form action="{{ route('buyer.orders.complete', $order->uuid) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('PATCH')
                        ...
                        <div class="modal fade" id="cancelModal{{ $order->id }}" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('buyer.orders.cancel', $order->uuid) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="cancel_reason"
                                                    id="reason1{{ $order->id }}" value="Salah dalam memilih produk" required>
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="cancel_reason"
                                                    id="reason2{{ $order->id }}"
                                                    value="Ingin mengubah atau membuat pesanan baru">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="cancel_reason"
                                                    id="reason3{{ $order->id }}"
                                                    value="Ingin menggunakan metode pembayaran lain">
                                            ...
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="radio" name="cancel_reason"
                                                    id="reason4{{ $order->id }}" value="Lainnya / Berubah pikiran">
                        ...
                        <div class="modal fade" id="returnModal{{ $order->id }}" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('buyer.orders.return', $order->uuid) }}" method="POST"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="return_reason"
                                                    id="return1{{ $order->id }}" value="Produk cacat/rusak" required>
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="return_reason"
                                                    id="return2{{ $order->id }}" value="Produk tidak sesuai deskripsi">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="return_reason"
                                                    id="return3{{ $order->id }}" value="Produk tidak lengkap">
                                            ...
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="radio" name="return_reason"
                                                    id="return4{{ $order->id }}" value="Lainnya">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="return_description" class="form-control" rows="3"
                                                    required></textarea>
                                            </div>
                                            <div class="mb-3">
