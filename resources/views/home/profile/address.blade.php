                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    @if(!$address->is_default)
                                    <form action="{{ route('admin.address.setDefault', $address->uuid) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <form action="{{ route('admin.address.delete', $address->uuid) }}" method="POST" class="d-inline" 
