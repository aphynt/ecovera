                            ...
                            <div class="col-6 text-end">
                                @php
                                    ...
                                    $statusTexts = [
                                        ...
                                        'paid' => 'Sudah Dibayar',
                                        'processed' => ($data['order']->payment_method === 'cod') ? 'Menyiapkan Pesanan' : 'Diproses',
                                        'shipped' => 'Dikirim',
                                        'completed' => 'Selesai',
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <strong class="text-primary">Rp
                                {{ number_format($data['order']->grand_total, 0, ',', '.') }}</strong>
                        </div>

                        @if($data['order']->status === 'pending')
                            <a href="{{ route('buyer.orders.payment', $data['order']->uuid) }}"
