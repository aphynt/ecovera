...
<main class="content-wrapper">
    ...
    <nav class="container pt-3 my-3 my-md-4" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.my.orders') }}">Pesanan Saya</a></li>
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.orders.payment', $data['order']->uuid) }}" class="btn btn-primary w-100 mb-2">
                            <i class="ci-credit-card me-2"></i>Bayar Sekarang
                        </a>
                        @elseif($data['order']->status === 'shipped')
                        <form action="{{ route('admin.orders.complete', $data['order']->uuid) }}" method="POST">
                            @csrf
                            @method('PATCH')
                        ...
                        <a href="{{ route('admin.my.orders') }}" class="btn btn-outline-secondary w-100">
