        ...
        <ol class="breadcrumb">
            ...
            @if($data['product']->category)
                <li class="breadcrumb-item"><a
                        href="{{ route('products.category', $data['product']->category->slug) }}">{{ $data['product']->category->name }}</a>
                </li>
            @endif
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="product-gallery">
                    <!-- Main image -->
                    <div class="mb-3">
                        <div class="ratio rounded-4 overflow-hidden bg-body-tertiary"
                        ...
                        <div class="d-flex gap-2 overflow-auto pb-2">
                            @foreach($data['product']->images as $image)
                                <button type="button"
                                    ...
                                    <img src="{{ asset('storage/' . $image->image_url) }}" alt="{{ $data['product']->name }}"
                                    ...
                                    <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                        ...
                                        <h3 class="fs-sm lh-base mb-0">
                                            <a class="hover-effect-underline fw-normal"
                                                href="{{ route('product.detail', $product->uuid) }}">
                                                {{ $product->name }}
                                            </a>
                                        </h3>
                                    </div>
