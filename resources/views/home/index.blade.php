          ...
          "autoplay": {
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide" style="background-color: #6dafca">
                            ...
                            <div class="row">
                                <div class="col-9 col-sm-8 col-md-7 col-lg-6">
                                    <p class="fs-sm text-white mb-lg-4">🔥 Free shipping - order over
                                        <strong>50$</strong></p>
                                    <h2 class="display-4 pb-2 pb-md-3 pb-lg-4">Healthy Food Available to Everyone
                                    </h2>
                    ...
                    <img src="{{ asset('home') }}/assets/img/home/grocery/hero-slider/01.jpg"
                ...
                <div class="swiper-slide" style="background-color: #5a7978">
                        ...
                        <div class="container mt-lg-n4">
                            <div class="row">
                                <div class="col-12 col-sm-10 col-md-7 col-lg-6">
                                    ...
                                    <h2 class="display-4 pb-2 pb-md-3 pb-lg-4">Organic eggs from home-grown chicken
                                    </h2>
                                    <a class="btn btn-lg btn-outline-light rounded-pill"
                                        href="shop-catalog-grocery.html">Shop now</a>
                                </div>
                    ...
                    <img src="{{ asset('home') }}/assets/img/home/grocery/hero-slider/02.jpg"
                        class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rtl-flip" alt="Image">
                </div>
                ...
                <div class="swiper-slide" style="background-color: #f99c03">
                    ...
                    <img src="{{ asset('home') }}/assets/img/home/grocery/hero-slider/03.jpg"
                        class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover rtl-flip" alt="Image">
                </div>
            </div>
                ...
                <div class="row nav g-3 g-sm-4">
                    <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                        <div class="position-relative d-flex min-w-0 align-items-center">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle"
                                ...
                                <img src="{{ asset('home') }}/assets/img/shop/grocery/categories/01.png" width="40"
                                    alt="Image">
                            </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                        <div class="position-relative d-flex min-w-0 align-items-center">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle"
                                style="width: 56px; height: 56px">
                                <img src="{{ asset('home') }}/assets/img/shop/grocery/categories/02.png" width="40"
                                    alt="Image">
                            </div>
                            <div class="min-w-0 ps-3">
                                <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1"
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                        <div class="position-relative d-flex min-w-0 align-items-center">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle"
                                style="width: 56px; height: 56px">
                                <img src="{{ asset('home') }}/assets/img/shop/grocery/categories/03.png" width="40"
                                    alt="Image">
                            </div>
                            <div class="min-w-0 ps-3">
                                <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1"
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                        <div class="position-relative d-flex min-w-0 align-items-center">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle"
                                style="width: 56px; height: 56px">
                                <img src="{{ asset('home') }}/assets/img/shop/grocery/categories/04.png" width="40"
                                    alt="Image">
                            </div>
                            <div class="min-w-0 ps-3">
                                <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1"
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                        <div class="position-relative d-flex min-w-0 align-items-center">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle"
                                style="width: 56px; height: 56px">
                                <img src="{{ asset('home') }}/assets/img/shop/grocery/categories/05.png" width="40"
                                    alt="Image">
                            </div>
                            <div class="min-w-0 ps-3">
                                <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1"
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                        <div class="position-relative d-flex min-w-0 align-items-center">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle"
                                style="width: 56px; height: 56px">
                                <img src="{{ asset('home') }}/assets/img/shop/grocery/categories/06.png" width="40"
                                    alt="Image">
                            </div>
                            <div class="min-w-0 ps-3">
                                <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1"
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                        <div class="position-relative d-flex min-w-0 align-items-center">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle"
                                style="width: 56px; height: 56px">
                                <img src="{{ asset('home') }}/assets/img/shop/grocery/categories/07.png" width="40"
                                    alt="Image">
                            </div>
                            <div class="min-w-0 ps-3">
                                <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1"
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-12 d-flex">
                        <div class="position-relative d-flex min-w-0 align-items-center">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-body-tertiary rounded-circle"
                                style="width: 56px; height: 56px">
                                <img src="{{ asset('home') }}/assets/img/shop/grocery/categories/08.png" width="40"
                                    alt="Image">
                            </div>
                            <div class="min-w-0 ps-3">
                                <a class="nav-link animate-underline stretched-link fs-base fw-semibold p-0 mb-1"
                        ...
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            <div class="position-relative z-2">
                                ...
                                <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                        <img src="{{ asset('home') }}/assets/img/shop/grocery/01.png" alt="Image">
                                    </div>
                                </a>
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery.html">Muesli
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            <div class="position-relative z-2">
                                ...
                                <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                        <img src="{{ asset('home') }}/assets/img/shop/grocery/02.png" alt="Image">
                                    </div>
                                </a>
                                <div class="position-absolute w-100 start-0 bottom-0">
                                    <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery.html">Fresh
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            <div class="position-relative z-2">
                                ...
                                <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                        <img src="{{ asset('home') }}/assets/img/shop/grocery/03.png" alt="Image">
                                    </div>
                                </a>
                                <div class="position-absolute w-100 start-0 bottom-0">
                                    <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery.html">Pepsi
                                        soda classic, can</a>
                                </h3>
                            </div>
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            <div class="position-relative z-2">
                                ...
                                <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                        <img src="{{ asset('home') }}/assets/img/shop/grocery/04.png" alt="Image">
                                    </div>
                                </a>
                                <div class="position-absolute w-100 start-0 bottom-0">
                                    <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            <div class="position-relative z-2">
                                ...
                                <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                        <img src="{{ asset('home') }}/assets/img/shop/grocery/05.png" alt="Image">
                                    </div>
                                </a>
                                <div class="position-absolute w-100 start-0 bottom-0">
                                    <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal"
                                        href="shop-product-grocery.html">Coconut, Indonesia</a>
                                </h3>
                            </div>
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            <div class="position-relative z-2">
                                ...
                                <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                        <img src="{{ asset('home') }}/assets/img/shop/grocery/06.png" alt="Image">
                                    </div>
                                </a>
                                <div class="position-absolute w-100 start-0 bottom-0">
                                    <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                            ...
                            <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                ...
                                <h3 class="fs-sm lh-base mb-0">
                                    <a class="hover-effect-underline fw-normal" href="shop-product-grocery.html">Pesto
                                        sauce Barilla with parmesan and
                                        basil</a>
                                </h3>
                            </div>
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            <div class="position-relative z-2">
                                ...
                                <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                        <img src="{{ asset('home') }}/assets/img/shop/grocery/07.png" alt="Image">
                                    </div>
                                </a>
                                <div class="position-absolute w-100 start-0 bottom-0">
                                    <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                    ...
                    <div class="col">
                        <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                            <div class="position-relative z-2">
                                ...
                                <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                        <img src="{{ asset('home') }}/assets/img/shop/grocery/08.png" alt="Image">
                                    </div>
                                </a>
                                <div class="position-absolute w-100 start-0 bottom-0">
                                    <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
            ...
            <div class="swiper-wrapper">
                    ...
                    <div
                        ...
                        <svg class="m-2" xmlns="http://www.w3.org/2000/svg" width="76" height="76" viewBox="0 0 76 76"
                            ...
                            <path
                                ...
                                stroke="currentColor" stroke-width="2.5" stroke-miterlimit="10" /></svg>
                    </div>
                    <h3 class="h5 mb-2">
                        <a class="animate-underline stretched-link" href="shop-catalog-grocery.html">
                ...
                <div class="swiper-slide text-center">
                    <div
                        ...
                        <svg class="m-2" xmlns="http://www.w3.org/2000/svg" width="76" height="76" viewBox="0 0 76 76"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-miterlimit="10"
                            stroke-linejoin="round">
                            <path
                ...
                <div class="pe-lg-2 pe-xl-4">
                    <div class="rounded-4 overflow-hidden" style="background-color: #a6cddc" data-bs-theme="light">
                        ...
                        <div class="ratio mt-n2" style="--cz-aspect-ratio: calc(240 / 282 * 100%)">
                            <img src="{{ asset('home') }}/assets/img/shop/grocery/banner.jpg" alt="Banner">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="swiper-slide h-auto">
                            <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                                <div class="position-relative z-2">
                                    ...
                                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                        <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                            <img src="{{ asset('home') }}/assets/img/shop/grocery/09.png" alt="Image">
                                        </div>
                                    </a>
                                    <div class="position-absolute w-100 start-0 bottom-0">
                                        <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                                ...
                                <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                    ...
                                    <h3 class="fs-sm lh-base mb-0">
                                        <a class="hover-effect-underline fw-normal"
                                            href="shop-product-grocery.html">Pure virgin olive oil Basso</a>
                                    </h3>
                                </div>
                                <div class="fs-xs text-body-secondary px-1 px-md-2 px-lg-3 pb-2 pb-md-3">1000ml
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide h-auto">
                            <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                                <div class="position-relative z-2">
                                    ...
                                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                        <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                            <img src="{{ asset('home') }}/assets/img/shop/grocery/10.png" alt="Image">
                                        </div>
                                    </a>
                                    <div class="position-absolute w-100 start-0 bottom-0">
                                        <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                                ...
                                <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                    ...
                                    <h3 class="fs-sm lh-base mb-0">
                                        <a class="hover-effect-underline fw-normal"
                                            href="shop-product-grocery.html">Fresh pork butt steaks with
                                            rosemary</a>
                                    </h3>
                                </div>
                                <div class="fs-xs text-body-secondary px-1 px-md-2 px-lg-3 pb-2 pb-md-3">500g</div>
                        ...
                        <div class="swiper-slide h-auto">
                            <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                                <div class="position-relative z-2">
                                    ...
                                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                        <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                            <img src="{{ asset('home') }}/assets/img/shop/grocery/11.png" alt="Image">
                                        </div>
                                    </a>
                                    <div class="position-absolute w-100 start-0 bottom-0">
                                        <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                                ...
                                <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                    ...
                                    <h3 class="fs-sm lh-base mb-0">
                                        <a class="hover-effect-underline fw-normal"
                                            href="shop-product-grocery.html">Fresh red grapefruit</a>
                                    </h3>
                                </div>
                                <div class="fs-xs text-body-secondary px-1 px-md-2 px-lg-3 pb-2 pb-md-3">1kg</div>
                            </div>
                        ...
                        <div class="swiper-slide h-auto">
                            <div class="card product-card h-100 bg-transparent border-0 shadow-none">
                                <div class="position-relative z-2">
                                    ...
                                    <a class="d-block p-2 p-lg-3" href="shop-product-grocery.html">
                                        <div class="ratio" style="--cz-aspect-ratio: calc(160 / 191 * 100%)">
                                            <img src="{{ asset('home') }}/assets/img/shop/grocery/12.png" alt="Image">
                                        </div>
                                    </a>
                                    <div class="position-absolute w-100 start-0 bottom-0">
                                        <div class="d-flex justify-content-end px-2 px-lg-3 pb-2 pb-lg-3">
                                ...
                                <div class="card-body pt-0 px-1 px-md-2 px-lg-3 pb-2">
                                    ...
                                    <h3 class="fs-sm lh-base mb-0">
                                        <a class="hover-effect-underline fw-normal"
                                            href="shop-product-grocery.html">Soft creme cheese with greens
                                            Exquisa</a>
                                    </h3>
                                </div>
                ...
                <div class="d-flex flex-column gap-1 gap-md-2">
                    ...
                    <div class="position-relative d-flex align-items-start align-items-sm-center mb-4">
                        <div class="ratio" style="--cz-aspect-ratio: calc(140 / 196 * 100%); max-width: 196px">
                            <img src="{{ asset('home') }}/assets/img/home/grocery/recipes/01.jpg" class="rounded"
                                alt="Image">
                        </div>
                        <div class="ps-3 ps-xl-4">
                            <h3 class="fs-base fw-medium lh-base mb-2 mb-xl-3">
                                <a class="hover-effect-underline stretched-link" href="#!">Garden salad with a mix
                                    of lettuce, cucumber and tomato</a>
                            </h3>
                    ...
                    <div class="position-relative d-flex align-items-start align-items-sm-center mb-4">
                        <div class="ratio" style="--cz-aspect-ratio: calc(140 / 196 * 100%); max-width: 196px">
                            <img src="{{ asset('home') }}/assets/img/home/grocery/recipes/02.jpg" class="rounded"
                                alt="Image">
                        </div>
                        <div class="ps-3 ps-xl-4">
                            <h3 class="fs-base fw-medium lh-base mb-2 mb-xl-3">
                                <a class="hover-effect-underline stretched-link" href="#!">Raspberry fresh lemonade
                                    with lemon, strawberry syrup and mint</a>
                            </h3>
                            <div class="d-flex gap-3 gap-xl-4 fs-sm text-body-secondary">
                                <div class="d-flex align-items-center text-nowrap">
                                    <i class="ci-clock fs-base me-2"></i>
                    ...
                    <div class="position-relative d-flex align-items-start align-items-sm-center mb-4">
                        <div class="ratio" style="--cz-aspect-ratio: calc(140 / 196 * 100%); max-width: 196px">
                            <img src="{{ asset('home') }}/assets/img/home/grocery/recipes/03.jpg" class="rounded"
                                alt="Image">
                        </div>
                        <div class="ps-3 ps-xl-4">
                            <h3 class="fs-base fw-medium lh-base mb-2 mb-xl-3">
                                <a class="hover-effect-underline stretched-link" href="#!">Penne pasta with spinach
                                    and zucchini in a creamy sauce</a>
                            </h3>
                            <div class="d-flex gap-3 gap-xl-4 fs-sm text-body-secondary">
                                <div class="d-flex align-items-center text-nowrap">
                                    <i class="ci-clock fs-base me-2"></i>
                ...
                <div class="border rounded-5 p-4">
                    <div
                        ...
                        <a class="ratio d-block w-100 mb-4 mb-sm-0" href="#!"
                            ...
                            <img src="{{ asset('home') }}/assets/img/home/grocery/recipes/book-cover.jpg"
                                class="rounded-4" alt="Book cover">
                        </a>
                        <div class="w-100 ps-sm-4 ms-md-2 ms-lg-0 ms-xl-2 ms-xxl-3">
                            ...
                            <p class="fs-sm pb-1 pb-xl-3">An exquisite cookbook that takes readers on a culinary
                                journey around the world. With stunning photography and detailed instructions ...
                            </p>
            ...
            <div class="col-lg-7 mb-4 mb-lg-0">
                <div
                    ...
                    <div class="ratio align-self-sm-end order-sm-1 rtl-flip"
                        ...
                        <img src="{{ asset('home') }}/assets/img/home/grocery/banner01.png" alt="Image">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <div class="d-flex align-items-center h-100 bg-body-tertiary rounded-5 overflow-hidden">
                    <div class="ratio align-self-end rtl-flip"
                        ...
                        <img src="{{ asset('home') }}/assets/img/home/grocery/banner02.png" alt="Image">
                    </div>
                    <div class="p-4">
