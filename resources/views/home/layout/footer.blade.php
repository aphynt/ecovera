            ...
            <div class="row pt-3 pb-4 py-md-1 py-lg-3">
                ...
                <div class="col-lg-3 text-center text-lg-start pb-sm-2 pb-md-0 mb-4 mb-md-5 mb-lg-0">
                    ...
                    <p class="fs-sm text-body mx-auto" style="max-width: 480px">With a wide selection of fresh produce,
                        pantry staples, and household essentials, we've got everything you need just a click away.</p>
        ...
        <p class="container fs-xs text-body text-center text-lg-start pb-md-3 mb-0">
            &copy; All rights reserved. Made with <i class="ci-heart-filled align-middle"></i> by <span
                class="animate-underline"><a class="animate-target text-white text-decoration-none"
                    href="https://1.envato.market/cartzilla-laravel" target="_blank"
                    rel="noreferrer">Coderthemes</a></span>
        </p>
    </footer>
