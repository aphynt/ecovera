        ...
        <div class="offcanvas-body d-flex flex-column gap-4 pt-2">
            ...
            <div class="d-flex align-items-center">
                <a class="position-relative flex-shrink-0" href="shop-product-grocery.html">
                    ...
                    <img src="{{ asset('home') }}/assets/img/shop/grocery/thumbs/01.png" width="110" alt="Thumbnail">
                </a>
            ...
            <div class="d-flex align-items-center">
                <a class="flex-shrink-0" href="shop-product-grocery.html">
                    <img src="{{ asset('home') }}/assets/img/shop/grocery/thumbs/02.png" width="110" alt="Thumbnail">
                </a>
                <div class="w-100 ps-3">
                    <h5 class="fs-sm fw-medium lh-base mb-2">
            ...
            <div class="d-flex align-items-center">
                <a class="flex-shrink-0" href="shop-product-grocery.html">
                    <img src="{{ asset('home') }}/assets/img/shop/grocery/thumbs/03.png" width="110" alt="Thumbnail">
                </a>
                <div class="w-100 ps-3">
                    <h5 class="fs-sm fw-medium lh-base mb-2">
            ...
            <div class="d-flex align-items-center">
                <a class="flex-shrink-0" href="shop-product-grocery.html">
                    <img src="{{ asset('home') }}/assets/img/shop/grocery/thumbs/04.png" width="110" alt="Thumbnail">
                </a>
                <div class="w-100 ps-3">
                    <h5 class="fs-sm fw-medium lh-base mb-2">
        ...
        <div class="offcanvas-body tab-content py-2 py-sm-3">
            ...
            <div class="tab-pane fade show active" id="delivery-tab-pane" role="tabpanel"
                ...
                <div class="collapse delivery-address" id="deliveryAddressAdd">
                    <div class="nav mb-4">
                        <a class="nav-link animate-underline p-0" href=".html" data-bs-toggle="collapse"
                ...
                <div class="nav">
                    <a class="nav-link hiding-collapse-toggle animate-underline collapsed px-0 mt-4" href=".html"
    ...
    <header class="navbar navbar-expand navbar-sticky sticky-top d-block bg-body z-fixed py-1 py-lg-0 py-xl-1 px-0"
        ...
        <div class="container justify-content-start py-2 py-lg-3">
            ...
            <div class="position-relative w-100 d-none d-md-block me-3 me-xl-4">
                <input type="search" class="form-control form-control-lg rounded-pill" placeholder="Cari barang"
                    aria-label="Search">
                <button type="button"
