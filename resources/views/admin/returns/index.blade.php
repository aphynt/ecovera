...
<!-- Admin View - Monitoring All Returns -->
    ...
    <div class="container-fluid">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Monitoring Pengembalian Barang (Admin)</h4>
                <small class="text-muted">Admin hanya memproses refund setelah seller menerima barang</small>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mb-1">{{ $stats['item_sent_back'] + $stats['item_received'] }}</h5>
                    ...
                    <table class="table table-hover table-striped align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-sm bg-info-subtle rounded-circle">
                                                <span class="avatar-title text-info fs-14">
                                                    {{ substr($return->seller->name ?? 'S', 0, 1) }}
                                                </span>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                            <h6 class="mb-0 fs-14">{{ $return->seller->name ?? '-' }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    @if($return->processor)
                                        <small>{{ $return->processor->name }}</small>
                                    @else
                                        <span class="text-muted">-</span>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('admin.returns.show', $return->uuid) }}" class="btn btn-sm btn-primary">
