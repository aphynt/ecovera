                            ...
                            <div class="widget-first">
                                ...
                                <div>
                                    <p class="text-muted mb-0 fs-13">
                                        <span class="text-primary fs-14 me-2"><i class="mdi mdi-trending-up fs-18"></i>
                                            12.5%</span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="widget-first">
                                ...
                                <div>
                                    <p class="text-muted mb-0 fs-13">
                                        <span class="text-danger fs-14 me-2"><i class="mdi mdi-trending-down fs-18"></i>
                                            1.5%</span>
                                        <small class="text-dark fs-14"> vs last 7 days </small>
                                    </p>
                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="avatar mb-0 position-relative">
                                                    <img class="avatar avatar-sm rounded-2 me-3 bg-primary-subtle rounded-circle p-1"
                                                        src="{{ asset('admin/dist') }}/assets/images/products/bag.png"
                                                        alt="product-image" />
                                                </span>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar mb-0 position-relative">
                                                    <img class="avatar avatar-sm rounded-2 me-3 bg-primary-subtle rounded-circle p-1"
                                                        src="{{ asset('admin/dist') }}/assets/images/products/watch.png"
                                                        alt="product-image" />
                                                </span>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar mb-0 position-relative">
                                                    <img class="avatar avatar-sm rounded-2 me-3 bg-primary-subtle rounded-circle p-1"
                                                        src="{{ asset('admin/dist') }}/assets/images/products/headphone.png"
                                                        alt="product-image" />
                                                </span>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar mb-0 position-relative">
                                                    <img class="avatar avatar-sm rounded-2 me-3 bg-primary-subtle rounded-circle p-1"
                                                        src="{{ asset('admin/dist') }}/assets/images/products/leather-jacket.png"
                                                        alt="product-image" />
                                                </span>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar mb-0 position-relative">
                                                    <img class="avatar avatar-sm rounded-2 me-3 bg-primary-subtle rounded-circle p-1"
                                                        src="{{ asset('admin/dist') }}/assets/images/products/shoes.png"
                                                        alt="product-image" />
                                                </span>
                                ...
                                <table class="table table-stock mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-danger-subtle text-danger fw-semibold fs-13">Out
                                                    of Stock</span>
                                            </td>
                                            <td>46 Pics</td>
                                        </tr>
                                ...
                                <table class="table table-traffic mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <img src="{{ asset('admin/dist') }}/assets/images/users/user-12.jpg"
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-primary-subtle text-primary fw-semibold">Delivered</span>
                                        </td>
                                        <td>
                                            <a aria-label="anchor" class="btn btn-sm bg-primary-subtle me-1"
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <img src="{{ asset('admin/dist') }}/assets/images/users/user-11.jpg"
                                                class="avatar avatar-sm rounded-circle me-3" />
                                            <div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <img src="{{ asset('admin/dist') }}/assets/images/users/user-13.jpg"
                                                class="avatar avatar-sm rounded-circle me-3" />
                                            <div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <img src="{{ asset('admin/dist') }}/assets/images/users/user-14.jpg"
                                                class="avatar avatar-sm rounded-circle me-3" />
                                            <div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <img src="{{ asset('admin/dist') }}/assets/images/users/user-15.jpg"
                                                class="avatar avatar-sm rounded-circle me-3" />
                                            <div>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-warning-subtle text-warning fw-semibold">Shipped</span>
                                        </td>
                                        <td>
                                            <a aria-label="anchor" class="btn btn-sm bg-primary-subtle me-1"
                                                data-bs-toggle="tooltip" data-bs-original-title="Edit">
